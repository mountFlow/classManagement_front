 ...
 -->
    ...
    <div style="margin: 20px; height: 99%">
      ...
      float: right;
          ...
          background-image: url(http://localhost:8080/brand_case_war_exploded/pic/building4.png);">
...
import {
  selectAll4Api as selectAllApi,
  add3Api as addApi,
  updateApi,
  deleteByIdApi,
  deleteByIdsApi,
  selectByCondition4Api as selectByConditionApi,
